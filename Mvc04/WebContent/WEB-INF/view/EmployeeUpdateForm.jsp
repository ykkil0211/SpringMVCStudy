		...
		<form action="employeeupdate.action" method="post" id="employeeForm">
			<table>
				...
				<tr>
					<th>이름</th>
					<td>
						<input type="text" id="name" name="name" value="${employee.name }" placeholder="이름">
					</td>
				</tr>
				<tr>
					<th>주민번호</th>
				...
				<tr>
					<th>전화번호</th>
					<td>
						<input type="tel" id="telephone" value="${employee.telephone }" name="telephone" placeholder="전화번호">
					</td>
				</tr>
				<tr>
					<th>지역</th>
